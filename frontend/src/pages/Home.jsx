                    ...
                    <div className="bg-white rounded-[2.5rem] p-10 lg:p-16 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100 flex flex-col lg:flex-row items-center justify-between gap-12">
                        ...
                        <div className="lg:w-1/2 flex flex-col items-center lg:items-end w-full">
                            ...
                            <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
                                <a href="#" target="_blank" rel="noopener noreferrer" className="group px-6 py-4 bg-[#0A66C2] hover:bg-[#004182] text-white font-medium rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1 flex items-center justify-center gap-3 w-full sm:w-auto">
                                    <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24"><path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/></svg>
                                    LinkedIn
                                </a>
                                <a href="#" target="_blank" rel="noopener noreferrer" className="group px-6 py-4 bg-[#24292F] hover:bg-black text-white font-medium rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1 flex items-center justify-center gap-3 w-full sm:w-auto">
                                ...
                                <a href="#" target="_blank" rel="noopener noreferrer" className="group px-6 py-4 bg-gradient-to-tr from-[#FD1D1D] via-[#E1306C] to-[#833AB4] hover:opacity-90 text-white font-medium rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1 flex items-center justify-center gap-3 w-full sm:w-auto">
