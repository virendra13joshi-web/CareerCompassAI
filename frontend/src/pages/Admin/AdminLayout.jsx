  ...
  return (
    <div className="flex h-screen bg-slate-950 overflow-hidden">
      ...
      <motion.aside
        ...
        className="flex-shrink-0 flex flex-col bg-slate-900 border-r border-slate-800 overflow-hidden"
      >
        {/* Logo + Toggle */}
            ...
            {!collapsed && (
              ...
              >
                ...
                <span className="text-white font-bold text-sm leading-tight">
                  CareerCompass<br />
                  <span className="text-indigo-400 text-xs font-medium">Admin Panel</span>
                </span>
              </motion.div>
            )}
          </AnimatePresence>
            ...
            >
              {({ isActive }) => (
                <>
                  ...
                  {collapsed && (
                    <div className="absolute left-full ml-3 px-2.5 py-1.5 bg-slate-700 text-white text-xs rounded-lg opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none whitespace-nowrap z-50 shadow-xl">
                      {item.label}
                    </div>
                  )}
                </>
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        {/* Top Header */}
        <header className="flex-shrink-0 bg-slate-900/50 backdrop-blur border-b border-slate-800 px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
